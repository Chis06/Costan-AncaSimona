...
CREATE TABLE `beneficiari` (
  ...
  PRIMARY KEY (`BeneficiarID`),
  KEY `FK_beneficiari_clienti` (`ClientID`),
  CONSTRAINT `FK_beneficiari_clienti` FOREIGN KEY (`ClientID`) REFERENCES `clienți` (`ID`)
...
CREATE TABLE `conturi` (
  ...
  PRIMARY KEY (`ContID`),
  KEY `FK_conturi_clienti` (`ClientID`),
  KEY `FK_conturi_tipuri` (`TipContID`),
  CONSTRAINT `FK_conturi_clienti` FOREIGN KEY (`ClientID`) REFERENCES `clienți` (`ID`),
  CONSTRAINT `FK_conturi_tipuri` FOREIGN KEY (`TipContID`) REFERENCES `tipuricont` (`TipCont`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `extrasecont` (
  ...
  KEY `FK_extrase_conturi` (`ContID`),
  CONSTRAINT `FK_extrase_conturi` FOREIGN KEY (`ContID`) REFERENCES `conturi` (`ContID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notificari` (
  `NotificareID` int(11) NOT NULL,
  `ClientID` int(11) DEFAULT NULL,
  `Mesaj` varchar(100) DEFAULT NULL,
  `Citit` bit(1) DEFAULT NULL,
  `DataNotificare` datetime DEFAULT NULL,
  PRIMARY KEY (`NotificareID`),
  KEY `FK_notificari_clienti` (`ClientID`),
  CONSTRAINT `FK_notificari_clienti` FOREIGN KEY (`ClientID`) REFERENCES `clienți` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transferuri` (
  ...
  KEY `FK_transferuri_sursa` (`ContSursa`),
  KEY `FK_transferuri_destinatie` (`ContDestinatie`),
  CONSTRAINT `FK_transferuri_destinatie` FOREIGN KEY (`ContDestinatie`) REFERENCES `conturi` (`ContID`),
  CONSTRAINT `FK_transferuri_sursa` FOREIGN KEY (`ContSursa`) REFERENCES `conturi` (`ContID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tranzacții` (
  `TranzacțieID` bigint(20) NOT NULL,
  `ContID` int(11) DEFAULT NULL,
  `TipTranzacție` varchar(100) DEFAULT NULL,
  `Suma` decimal(10,0) DEFAULT NULL,
  `DataTranzacție` datetime DEFAULT NULL,
  PRIMARY KEY (`TranzacțieID`),
  KEY `FK_tranzactii_conturi` (`ContID`),
  CONSTRAINT `FK_tranzactii_conturi` FOREIGN KEY (`ContID`) REFERENCES `conturi` (`ContID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-30 18:14:41
